 ...
 *
 * <pre>
 *   plannerAppDev = angular.module('plannerAppDev', ['plannerApp', 'ngMockE2E']);
 *   plannerAppDev.run(function($httpBackend) {
...
if(window.jasmine || window.mocha) {
   ...
   * <pre>
   *
   *   angular.module('plannerApplicationModule', [])
   *       .value('mode', 'app')
   ...
   *     beforeEach(module('plannerApplicationModule'));
   *
   *
